					...
					<div class="sns_login">
						<div class="kakao_login">
							<img src="resources/image/kakao.jpg"><input type="button"
								onclick="location.href='https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=7be620bec56f17ae41e078a7330e78f7&redirect_uri=http://localhost:8080/kakaoLogin'" value="카카오 로그인"
								class="kakao">
						</div>
